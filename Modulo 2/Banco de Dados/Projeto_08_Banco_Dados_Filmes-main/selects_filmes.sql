...
SELECT * FROM filmes WHERE genero in ("Terror", "Drama") and  ano_lancamento > 1979 and ano_lancamento < 2003 
...
SELECT * FROM filmes WHERE diretor like "%James Cameron%"
-- 14. Por fim vamos adiconar as informações do seu filme favorito na tabela.
INSERT INTO filmes (titulo, genero, ano_lancamento,duracao_minutos,diretor,nota_imdb) values ("Spirit: O Corcel Indomável","infantil", 2002, 104," Kelly Asbury",7.2)
-- 15. Vamos adiconar as informações do filme que o professor odeia.
INSERT INTO filmes (titulo, genero, ano_lancamento,duracao_minutos,diretor,nota_imdb) values ("Homem-Aranha: Longe de Casa","Açâo", 2019, 130,"Jon Watts",7.3)
